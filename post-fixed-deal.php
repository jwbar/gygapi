...
// Function to create a deal using POST with hardcoded Basic Authentication
function postDeal($api_url, $dealData) {
    ...
    // Set Basic Authentication with hardcoded credentials
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = postDeal($api_url, $dealData);
